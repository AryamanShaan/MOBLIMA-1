...
public class Movie {
	...
	public Movie(String name, String type, String status, String synopsis, String director, String[] cast, String rating){
		this.movieName = name;
		this.movieType = type;
	...
	// MovieRating Accessor and Mutator
	
	/*
	public void setMovieRating(){
		this.movieRating = 0.0;  // At the time of creating of this object, movieRating should be set to 0
	}
	*/
	...
	public void writeMovie() throws IOException{
		...
		String Save = this.getMovieName() + "," + this.getMovieType() + "," + this.getMovieStatus() + "," + this.getMovieRating() + "," + this.getMovieSynopsis() + "," + this.getMovieDirector() + "," + cast;
		try {
